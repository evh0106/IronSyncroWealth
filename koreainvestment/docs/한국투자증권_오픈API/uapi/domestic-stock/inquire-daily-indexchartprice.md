...
- 개요: 국내주식 업종기간별시세(일/주/월/년) API입니다.
...
||tr_id|거래ID|string|Y|13|'[실전투자/모의투자]<br>FHKUP03500100'|
...
||FID_INPUT_ISCD|업종 상세코드|string|Y|2|'0001 : 종합<br>0002 : 대형주<br>...<br>포탈 (FAQ : 종목정보 다운로드(국내) - 업종코드 참조)'|
