...
||FID_INPUT_ISCD|종목코드|string|Y|12|ex. 005930(삼성전자) <br><br>※ FID_INPUT_ISCD(종목코드) 혹은 FID_MRKT_CLS_CODE(시장구분코드) 둘 중 하나만 입력<br>|
||FID_INPUT_ISCD_2|회원사코드|string|Y|10|ex. 99999(전체)<br><br>※ 회원사코드 (kis developers 포탈 사이트 포럼-> FAQ -> 종목정보 다운로드(국내) 참조)<br>|
