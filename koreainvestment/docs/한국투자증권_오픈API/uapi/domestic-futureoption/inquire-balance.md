...
||sll_buy_dvsn_name|매도매수구분명|string|Y|4|매도/매수 구분의 명칭<br><br>- 매수잔고를 가진 경우, "매수" 혹은 "BUY"로 출력<br>- 매도잔고를 가진 경우, "매도" 혹은 "SLL"로 출력<br>- 당일 잔고를 청산하여 잔고를 가지고 있지 않은 경우 빈칸으로 출력<br>|
