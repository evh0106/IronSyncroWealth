...
- 개요: 해외주식 종목/지수/환율기간별시세(일/주/월/년) API입니다.
...
||tr_id|거래ID|string|Y|13|[실전투자/모의투자]<br>FHKST03030100|
...
||FID_INPUT_ISCD|FID 입력 종목코드|string|Y|12|종목코드<br>※ 해외주식 마스터 코드 참조 <br>(포럼 > FAQ > 종목정보 다운로드(해외) > 해외지수)<br><br>※ 해당 API로 미국주식 조회 시, 다우30, 나스닥100, S&P500 종목만 조회 가능합니다. 더 많은 미국주식 종목 시세를 이용할 시에는, 해외주식기간별시세 API 사용 부탁드립니다.|
