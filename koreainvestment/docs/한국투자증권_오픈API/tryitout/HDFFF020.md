...
- 개요: ※ CME, SGX 실시간시세 유료시세 신청 필수 (포럼 &gt; FAQ &gt; 해외선물옵션 API 유료시세 신청방법(CME, SGX 거래소))
...
|Response Header|||||||
|Response Body|SERIES_CD|종목코드|string|Y|32|'각 항목사이에는 구분자로 ^ 사용,<br>모든 데이터타입은 String으로 변환되어 push 처리됨'|
