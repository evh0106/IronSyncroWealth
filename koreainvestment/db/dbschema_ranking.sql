...
DROP TABLE IF EXISTS overtime_exp_trans_fluct CASCADE;
DROP TABLE IF EXISTS exp_trans_updown CASCADE;
DROP TABLE IF EXISTS quote_balance CASCADE;
DROP TABLE IF EXISTS credit_balance CASCADE;
DROP TABLE IF EXISTS overtime_volume CASCADE;
DROP TABLE IF EXISTS dividend_rate CASCADE;
DROP TABLE IF EXISTS after_hour_balance CASCADE;
DROP TABLE IF EXISTS short_sale CASCADE;
DROP TABLE IF EXISTS disparity CASCADE;
DROP TABLE IF EXISTS hts_top_view CASCADE;
DROP TABLE IF EXISTS profit_asset_index CASCADE;
DROP TABLE IF EXISTS near_new_highlow CASCADE;
DROP TABLE IF EXISTS prefer_disparate_ratio CASCADE;
DROP TABLE IF EXISTS bulk_trans_num CASCADE;
DROP TABLE IF EXISTS finance_ratio CASCADE;
DROP TABLE IF EXISTS market_cap CASCADE;
DROP TABLE IF EXISTS traded_by_company CASCADE;
DROP TABLE IF EXISTS fluctuation CASCADE;
DROP TABLE IF EXISTS market_value CASCADE;
DROP TABLE IF EXISTS top_interest_stock CASCADE;
DROP TABLE IF EXISTS volume_power CASCADE;
DROP TABLE IF EXISTS overtime_fluctuation CASCADE;
...
CREATE TABLE IF NOT EXISTS overtime_exp_trans_fluct (
    ...
    req_fid_input_vol_1              TEXT NULL COMMENT '요청 FID_INPUT_VOL_1',
    ...
    rsp_ovtm_untp_antc_cntg_vrsssign TEXT NULL COMMENT '응답 ovtm_untp_antc_cntg_vrsssign',
    ...
    rsp_itmt_vol                     TEXT NULL COMMENT '응답 itmt_vol',
...
CREATE TABLE IF NOT EXISTS exp_trans_updown (
    ...
    req_fid_input_price_1      TEXT NULL COMMENT '요청 fid_input_price_1',
    req_fid_input_price_2      TEXT NULL COMMENT '요청 fid_input_price_2',
    req_fid_aply_rang_prc_1    TEXT NULL COMMENT '요청 fid_aply_rang_prc_1',
    req_fid_vol_cnt            TEXT NULL COMMENT '요청 fid_vol_cnt',
    req_fid_pbmn               TEXT NULL COMMENT '요청 fid_pbmn',
...
CREATE TABLE IF NOT EXISTS quote_balance (
    ...
    rsp_total_ntsl_bidp_rsqn   TEXT NULL COMMENT '응답 total_ntsl_bidp_rsqn',
...
CREATE TABLE IF NOT EXISTS credit_balance (
    ...
    req_fid_cond_scr_div_code    TEXT NULL COMMENT '요청 FID_COND_SCR_DIV_CODE',
    req_fid_input_iscd           TEXT NULL COMMENT '요청 FID_INPUT_ISCD',
    req_fid_option               TEXT NULL COMMENT '요청 FID_OPTION',
    req_fid_cond_mrkt_div_code   TEXT NULL COMMENT '요청 FID_COND_MRKT_DIV_CODE',
    req_fid_rank_sort_cls_code   TEXT NULL COMMENT '요청 FID_RANK_SORT_CLS_CODE',
    rt_cd                        VARCHAR(10) NOT NULL DEFAULT '' COMMENT '응답 rt_cd',
    msg_cd                       VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    ...
    rsp_stnd_date2               TEXT NULL COMMENT '응답 stnd_date2',
    rsp_mksc_shrn_iscd           TEXT NULL COMMENT '응답 mksc_shrn_iscd',
    rsp_stck_prpr                TEXT NULL COMMENT '응답 stck_prpr',
    rsp_prdy_vrss                TEXT NULL COMMENT '응답 prdy_vrss',
    rsp_prdy_vrss_sign           TEXT NULL COMMENT '응답 prdy_vrss_sign',
    ...
    rsp_nday_vrss_loan_rmnd_inrt TEXT NULL COMMENT '응답 nday_vrss_loan_rmnd_inrt',
    rsp_nday_vrss_stln_rmnd_inrt TEXT NULL COMMENT '응답 nday_vrss_stln_rmnd_inrt',
    fetched_at                   DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS overtime_volume (
    ...
    msg_cd                       VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    msg1                         VARCHAR(255) NOT NULL DEFAULT '' COMMENT '응답 msg1',
    rsp_ovtm_untp_exch_vol       TEXT NULL COMMENT '응답 ovtm_untp_exch_vol',
    rsp_ovtm_untp_exch_tr_pbmn   TEXT NULL COMMENT '응답 ovtm_untp_exch_tr_pbmn',
    rsp_ovtm_untp_kosdaq_vol     TEXT NULL COMMENT '응답 ovtm_untp_kosdaq_vol',
    rsp_ovtm_untp_kosdaq_tr_pbmn TEXT NULL COMMENT '응답 ovtm_untp_kosdaq_tr_pbmn',
    rsp_stck_shrn_iscd           TEXT NULL COMMENT '응답 stck_shrn_iscd',
    rsp_hts_kor_isnm             TEXT NULL COMMENT '응답 hts_kor_isnm',
    ...
    rsp_ovtm_untp_seln_rsqn      TEXT NULL COMMENT '응답 ovtm_untp_seln_rsqn',
    rsp_ovtm_untp_shnu_rsqn      TEXT NULL COMMENT '응답 ovtm_untp_shnu_rsqn',
    rsp_ovtm_untp_vol            TEXT NULL COMMENT '응답 ovtm_untp_vol',
    rsp_ovtm_vrss_acml_vol_rlim  TEXT NULL COMMENT '응답 ovtm_vrss_acml_vol_rlim',
    rsp_stck_prpr                TEXT NULL COMMENT '응답 stck_prpr',
    rsp_acml_vol                 TEXT NULL COMMENT '응답 acml_vol',
...
CREATE TABLE IF NOT EXISTS dividend_rate (
    ...
    tr_id                VARCHAR(32) NOT NULL DEFAULT '' COMMENT 'TR ID',
    req_url              VARCHAR(200) NOT NULL DEFAULT '' COMMENT '요청 URL',
    req_cts_area         TEXT NULL COMMENT '요청 CTS_AREA',
    req_gb1              TEXT NULL COMMENT '요청 GB1',
    req_upjong           TEXT NULL COMMENT '요청 UPJONG',
    req_gb2              TEXT NULL COMMENT '요청 GB2',
    req_gb3              TEXT NULL COMMENT '요청 GB3',
    req_f_dt             TEXT NULL COMMENT '요청 F_DT',
    req_t_dt             TEXT NULL COMMENT '요청 T_DT',
    req_gb4              TEXT NULL COMMENT '요청 GB4',
    rt_cd                VARCHAR(10) NOT NULL DEFAULT '' COMMENT '응답 rt_cd',
    msg_cd               VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    msg1                 VARCHAR(255) NOT NULL DEFAULT '' COMMENT '응답 msg1',
    rsp_rank             TEXT NULL COMMENT '응답 rank',
    rsp_sht_cd           TEXT NULL COMMENT '응답 sht_cd',
    rsp_isin_name        TEXT NULL COMMENT '응답 isin_name',
    rsp_record_date      TEXT NULL COMMENT '응답 record_date',
    rsp_per_sto_divi_amt TEXT NULL COMMENT '응답 per_sto_divi_amt',
    rsp_divi_rate        TEXT NULL COMMENT '응답 divi_rate',
    rsp_divi_kind        TEXT NULL COMMENT '응답 divi_kind',
    fetched_at           DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS after_hour_balance (
    ...
    rsp_mkob_otcp_vol          TEXT NULL COMMENT '응답 mkob_otcp_vol',
    rsp_mkfa_otcp_vol          TEXT NULL COMMENT '응답 mkfa_otcp_vol',
    fetched_at                 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS short_sale (
    ...
    req_fid_input_cnt_1        TEXT NULL COMMENT '요청 FID_INPUT_CNT_1',
    req_fid_trgt_exls_cls_code TEXT NULL COMMENT '요청 FID_TRGT_EXLS_CLS_CODE',
    req_fid_trgt_cls_code      TEXT NULL COMMENT '요청 FID_TRGT_CLS_CODE',
    req_fid_aply_rang_vol      TEXT NULL COMMENT '요청 FID_APLY_RANG_VOL',
    req_fid_aply_rang_prc_1    TEXT NULL COMMENT '요청 FID_APLY_RANG_PRC_1',
    req_fid_aply_rang_prc_2    TEXT NULL COMMENT '요청 FID_APLY_RANG_PRC_2',
    rt_cd                      VARCHAR(10) NOT NULL DEFAULT '' COMMENT '응답 rt_cd',
    msg_cd                     VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    msg1                       VARCHAR(255) NOT NULL DEFAULT '' COMMENT '응답 msg1',
    rsp_mksc_shrn_iscd         TEXT NULL COMMENT '응답 mksc_shrn_iscd',
...
CREATE TABLE IF NOT EXISTS disparity (
    ...
    rsp_prdy_vrss_sign         TEXT NULL COMMENT '응답 prdy_vrss_sign',
    rsp_acml_vol               TEXT NULL COMMENT '응답 acml_vol',
    rsp_d5_dsrt                TEXT NULL COMMENT '응답 d5_dsrt',
    rsp_d10_dsrt               TEXT NULL COMMENT '응답 d10_dsrt',
    rsp_d20_dsrt               TEXT NULL COMMENT '응답 d20_dsrt',
    rsp_d60_dsrt               TEXT NULL COMMENT '응답 d60_dsrt',
    rsp_d120_dsrt              TEXT NULL COMMENT '응답 d120_dsrt',
    fetched_at                 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS hts_top_view (
    ...
    msg_cd                VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    msg1                  VARCHAR(255) NOT NULL DEFAULT '' COMMENT '응답 msg1',
    rsp_mrkt_div_cls_code TEXT NULL COMMENT '응답 mrkt_div_cls_code',
    rsp_mksc_shrn_iscd    TEXT NULL COMMENT '응답 mksc_shrn_iscd',
    fetched_at            DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
...
CREATE TABLE IF NOT EXISTS profit_asset_index (
    ...
    req_fid_input_price_2      TEXT NULL COMMENT '요청 fid_input_price_2',
    req_fid_vol_cnt            TEXT NULL COMMENT '요청 fid_vol_cnt',
    req_fid_input_option_1     TEXT NULL COMMENT '요청 fid_input_option_1',
    req_fid_input_option_2     TEXT NULL COMMENT '요청 fid_input_option_2',
    req_fid_rank_sort_cls_code TEXT NULL COMMENT '요청 fid_rank_sort_cls_code',
    req_fid_blng_cls_code      TEXT NULL COMMENT '요청 fid_blng_cls_code',
    req_fid_trgt_exls_cls_code TEXT NULL COMMENT '요청 fid_trgt_exls_cls_code',
    rt_cd                      VARCHAR(10) NOT NULL DEFAULT '' COMMENT '응답 rt_cd',
    ...
    rsp_prdy_ctrt              TEXT NULL COMMENT '응답 prdy_ctrt',
    rsp_acml_vol               TEXT NULL COMMENT '응답 acml_vol',
    rsp_sale_totl_prfi         TEXT NULL COMMENT '응답 sale_totl_prfi',
    rsp_bsop_prti              TEXT NULL COMMENT '응답 bsop_prti',
    rsp_op_prfi                TEXT NULL COMMENT '응답 op_prfi',
    rsp_thtr_ntin              TEXT NULL COMMENT '응답 thtr_ntin',
    rsp_total_aset             TEXT NULL COMMENT '응답 total_aset',
    rsp_total_lblt             TEXT NULL COMMENT '응답 total_lblt',
    rsp_total_cptl             TEXT NULL COMMENT '응답 total_cptl',
    rsp_stac_month             TEXT NULL COMMENT '응답 stac_month',
    rsp_stac_month_cls_code    TEXT NULL COMMENT '응답 stac_month_cls_code',
    rsp_iqry_csnu              TEXT NULL COMMENT '응답 iqry_csnu',
    fetched_at                 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS finance_ratio (
    ...
    rsp_prdy_ctrt              TEXT NULL COMMENT '응답 prdy_ctrt',
    rsp_acml_vol               TEXT NULL COMMENT '응답 acml_vol',
    rsp_cptl_op_prfi           TEXT NULL COMMENT '응답 cptl_op_prfi',
    rsp_cptl_ntin_rate         TEXT NULL COMMENT '응답 cptl_ntin_rate',
    rsp_sale_totl_rate         TEXT NULL COMMENT '응답 sale_totl_rate',
    rsp_sale_ntin_rate         TEXT NULL COMMENT '응답 sale_ntin_rate',
    rsp_bis                    TEXT NULL COMMENT '응답 bis',
    rsp_lblt_rate              TEXT NULL COMMENT '응답 lblt_rate',
    rsp_bram_depn              TEXT NULL COMMENT '응답 bram_depn',
    rsp_rsrv_rate              TEXT NULL COMMENT '응답 rsrv_rate',
    rsp_grs                    TEXT NULL COMMENT '응답 grs',
    rsp_op_prfi_inrt           TEXT NULL COMMENT '응답 op_prfi_inrt',
    rsp_bsop_prfi_inrt         TEXT NULL COMMENT '응답 bsop_prfi_inrt',
    rsp_ntin_inrt              TEXT NULL COMMENT '응답 ntin_inrt',
    rsp_equt_inrt              TEXT NULL COMMENT '응답 equt_inrt',
    rsp_cptl_tnrt              TEXT NULL COMMENT '응답 cptl_tnrt',
    rsp_sale_bond_tnrt         TEXT NULL COMMENT '응답 sale_bond_tnrt',
    rsp_totl_aset_inrt         TEXT NULL COMMENT '응답 totl_aset_inrt',
    rsp_stac_month             TEXT NULL COMMENT '응답 stac_month',
    rsp_stac_month_cls_code    TEXT NULL COMMENT '응답 stac_month_cls_code',
    rsp_iqry_csnu              TEXT NULL COMMENT '응답 iqry_csnu',
    fetched_at                 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
...
CREATE TABLE IF NOT EXISTS market_cap (
    ...
    rsp_stck_avls              TEXT NULL COMMENT '응답 stck_avls',
    rsp_mrkt_whol_avls_rlim    TEXT NULL COMMENT '응답 mrkt_whol_avls_rlim',
    fetched_at                 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS fluctuation (
    ...
    req_fid_trgt_exls_cls_code        TEXT NULL COMMENT '요청 fid_trgt_exls_cls_code',
    req_fid_div_cls_code              TEXT NULL COMMENT '요청 fid_div_cls_code',
    req_fid_rsfl_rate1                TEXT NULL COMMENT '요청 fid_rsfl_rate1',
    req_fid_rsfl_rate2                TEXT NULL COMMENT '요청 fid_rsfl_rate2',
    rt_cd                             VARCHAR(10) NOT NULL DEFAULT '' COMMENT '응답 rt_cd',
    msg_cd                            VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    msg1                              VARCHAR(255) NOT NULL DEFAULT '' COMMENT '응답 msg1',
    rsp_stck_shrn_iscd                TEXT NULL COMMENT '응답 stck_shrn_iscd',
    ...
    rsp_acml_hgpr_date                TEXT NULL COMMENT '응답 acml_hgpr_date',
    rsp_stck_lwpr                     TEXT NULL COMMENT '응답 stck_lwpr',
    rsp_lwpr_hour                     TEXT NULL COMMENT '응답 lwpr_hour',
    rsp_acml_lwpr_date                TEXT NULL COMMENT '응답 acml_lwpr_date',
    rsp_lwpr_vrss_prpr_rate           TEXT NULL COMMENT '응답 lwpr_vrss_prpr_rate',
    rsp_dsgt_date_clpr_vrss_prpr_rate TEXT NULL COMMENT '응답 dsgt_date_clpr_vrss_prpr_rate',
    rsp_cnnt_ascn_dynu                TEXT NULL COMMENT '응답 cnnt_ascn_dynu',
    rsp_hgpr_vrss_prpr_rate           TEXT NULL COMMENT '응답 hgpr_vrss_prpr_rate',
    rsp_cnnt_down_dynu                TEXT NULL COMMENT '응답 cnnt_down_dynu',
    rsp_oprc_vrss_prpr_sign           TEXT NULL COMMENT '응답 oprc_vrss_prpr_sign',
    rsp_oprc_vrss_prpr                TEXT NULL COMMENT '응답 oprc_vrss_prpr',
    rsp_oprc_vrss_prpr_rate           TEXT NULL COMMENT '응답 oprc_vrss_prpr_rate',
    rsp_prd_rsfl                      TEXT NULL COMMENT '응답 prd_rsfl',
    rsp_prd_rsfl_rate                 TEXT NULL COMMENT '응답 prd_rsfl_rate',
    fetched_at                        DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS market_value (
    ...
    rsp_pcr                    TEXT NULL COMMENT '응답 pcr',
    rsp_psr                    TEXT NULL COMMENT '응답 psr',
    rsp_eps                    TEXT NULL COMMENT '응답 eps',
    rsp_eva                    TEXT NULL COMMENT '응답 eva',
    rsp_ebitda                 TEXT NULL COMMENT '응답 ebitda',
    rsp_pv_div_ebitda          TEXT NULL COMMENT '응답 pv_div_ebitda',
    rsp_ebitda_div_fnnc_expn   TEXT NULL COMMENT '응답 ebitda_div_fnnc_expn',
    rsp_stac_month             TEXT NULL COMMENT '응답 stac_month',
    rsp_stac_month_cls_code    TEXT NULL COMMENT '응답 stac_month_cls_code',
    rsp_iqry_csnu              TEXT NULL COMMENT '응답 iqry_csnu',
    fetched_at                 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
...
CREATE TABLE IF NOT EXISTS top_interest_stock (
    ...
    msg_cd                     VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    msg1                       VARCHAR(255) NOT NULL DEFAULT '' COMMENT '응답 msg1',
    rsp_mrkt_div_cls_name      TEXT NULL COMMENT '응답 mrkt_div_cls_name',
    rsp_mksc_shrn_iscd         TEXT NULL COMMENT '응답 mksc_shrn_iscd',
    rsp_hts_kor_isnm           TEXT NULL COMMENT '응답 hts_kor_isnm',
    rsp_stck_prpr              TEXT NULL COMMENT '응답 stck_prpr',
    rsp_prdy_vrss              TEXT NULL COMMENT '응답 prdy_vrss',
    ...
    rsp_bidp                   TEXT NULL COMMENT '응답 bidp',
    rsp_data_rank              TEXT NULL COMMENT '응답 data_rank',
    rsp_inter_issu_reg_csnu    TEXT NULL COMMENT '응답 inter_issu_reg_csnu',
    fetched_at                 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '수집일시',
    PRIMARY KEY (id),
    INDEX idx_req_dt (fetched_at),
    INDEX idx_tr_id (tr_id),
...
CREATE TABLE IF NOT EXISTS overtime_fluctuation (
    ...
    msg_cd                       VARCHAR(20) NOT NULL DEFAULT '' COMMENT '응답 msg_cd',
    msg1                         VARCHAR(255) NOT NULL DEFAULT '' COMMENT '응답 msg1',
    rsp_ovtm_untp_uplm_issu_cnt  TEXT NULL COMMENT '응답 ovtm_untp_uplm_issu_cnt',
    rsp_ovtm_untp_ascn_issu_cnt  TEXT NULL COMMENT '응답 ovtm_untp_ascn_issu_cnt',
    rsp_ovtm_untp_stnr_issu_cnt  TEXT NULL COMMENT '응답 ovtm_untp_stnr_issu_cnt',
    rsp_ovtm_untp_lslm_issu_cnt  TEXT NULL COMMENT '응답 ovtm_untp_lslm_issu_cnt',
    rsp_ovtm_untp_down_issu_cnt  TEXT NULL COMMENT '응답 ovtm_untp_down_issu_cnt',
    rsp_ovtm_untp_acml_vol       TEXT NULL COMMENT '응답 ovtm_untp_acml_vol',
    rsp_ovtm_untp_acml_tr_pbmn   TEXT NULL COMMENT '응답 ovtm_untp_acml_tr_pbmn',
    rsp_ovtm_untp_exch_vol       TEXT NULL COMMENT '응답 ovtm_untp_exch_vol',
    rsp_ovtm_untp_exch_tr_pbmn   TEXT NULL COMMENT '응답 ovtm_untp_exch_tr_pbmn',
    rsp_ovtm_untp_kosdaq_vol     TEXT NULL COMMENT '응답 ovtm_untp_kosdaq_vol',
    rsp_ovtm_untp_kosdaq_tr_pbmn TEXT NULL COMMENT '응답 ovtm_untp_kosdaq_tr_pbmn',
