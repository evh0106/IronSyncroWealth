...
CREATE TABLE IF NOT EXISTS ka20001_header (
    ...
    pred_pre_sig            CHAR(1)                COMMENT '전일대비기호(1:상한,2:상승,3:보합,4:하한,5:하락)',
...
) COMMENT='ka20001 업종현재가 헤더';

CREATE TABLE IF NOT EXISTS ka20001_inds_cur_prc_tm (
    id              BIGINT        NOT NULL AUTO_INCREMENT,
    header_id       BIGINT        NOT NULL COMMENT 'ka20001_header.id',
    tm_n            VARCHAR(6)             COMMENT '시간',
