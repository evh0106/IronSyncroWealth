...
-- -------------------------------------------------------------
DROP TABLE IF EXISTS ka00198_item_inq_rank;
DROP TABLE IF EXISTS ka10001;
DROP TABLE IF EXISTS ka10002;
DROP TABLE IF EXISTS ka10003_cntr_infr;
DROP TABLE IF EXISTS ka10013_crd_trde_trend;
DROP TABLE IF EXISTS ka10015_daly_trde_dtl;
DROP TABLE IF EXISTS ka10016_ntl_pric;
DROP TABLE IF EXISTS ka10017_updown_pric;
DROP TABLE IF EXISTS ka10018_high_low_pric_alacc;
DROP TABLE IF EXISTS ka10019_pric_jmpflu;
DROP TABLE IF EXISTS ka10024_trde_qty_updt;
DROP TABLE IF EXISTS ka10025_prps_cnctr;
DROP TABLE IF EXISTS ka10026_high_low_per;
DROP TABLE IF EXISTS ka10028_open_pric_pre_flu_rt;
DROP TABLE IF EXISTS ka10043_trde_ori_prps_anly;
DROP TABLE IF EXISTS ka10052_trde_ori_mont_trde_qty;
DROP TABLE IF EXISTS ka10054_motn_stk;
DROP TABLE IF EXISTS ka10055_tdy_pred_cntr_qty;
DROP TABLE IF EXISTS ka10058_invsr_daly_trde_stk;
DROP TABLE IF EXISTS ka10059_stk_invsr_orgn;
DROP TABLE IF EXISTS ka10061_stk_invsr_orgn_tot;
DROP TABLE IF EXISTS ka10084_tdy_pred_cntr;
DROP TABLE IF EXISTS ka10095_atn_stk_infr;
DROP TABLE IF EXISTS ka10099_list;
DROP TABLE IF EXISTS ka10100;
DROP TABLE IF EXISTS ka10101_list;
DROP TABLE IF EXISTS ka10102_list;
DROP TABLE IF EXISTS ka90003_prm_netprps_upper_50;
DROP TABLE IF EXISTS ka90004_header;
DROP TABLE IF EXISTS ka90004_stk_prm_trde_prst;
DROP TABLE IF EXISTS kt20016_header;
DROP TABLE IF EXISTS kt20016_crd_loan_pos_stk;
DROP TABLE IF EXISTS kt20017;
DROP TABLE IF EXISTS ka10023_trde_qty_sdnin;
DROP TABLE IF EXISTS ka10030_tdy_trde_qty_upper;
DROP TABLE IF EXISTS ka10031_pred_trde_qty_upper;
DROP TABLE IF EXISTS ka10032_trde_prica_upper;
